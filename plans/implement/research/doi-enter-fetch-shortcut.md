# Implement: doi-enter-fetch-shortcut

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/doi-enter-fetch-shortcut.md`)의 핵심 동작: DOI 입력 포커스 상태에서 Enter 시 Fetch 버튼과 동일 경로로 조회 실행.
- design(`plans/design/research/doi-enter-fetch-shortcut.md`)의 Component breakdown / States를 코드로 옮긴다.
...
## 의존
- 선행 implement: `doi-arxiv-input-field`
...
8. `plans/test/research/doi-enter-fetch-shortcut.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.