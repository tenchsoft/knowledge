# Implement: welcome-import-from-file-button

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/welcome-import-from-file-button.md`)의 핵심 동작: Import from file 버튼 클릭 시 환영 오버레이 닫기 및 가져오기 큐 시작.
- design(`plans/design/research/welcome-import-from-file-button.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.welcome.import` | `Button` | `Import from file` | show_welcome=true |

## 의존
- 선행 implement: `welcome-get-started-button`
...
8. `plans/test/research/welcome-import-from-file-button.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.