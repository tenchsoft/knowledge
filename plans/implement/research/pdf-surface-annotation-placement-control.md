# Implement: pdf-surface-annotation-placement-control

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/pdf-surface-annotation-placement-control.md`)의 핵심 동작: 어노테이션 도구 활성 상태에서 PDF 페이지 클릭 시 새 주석 생성.
- design(`plans/design/research/pdf-surface-annotation-placement-control.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.pdf.surface` | `Canvas` | `PDF surface` | PDF 모드 |

## 의존
- 선행 implement: `pdf-highlight-tool-button`
...
8. `plans/test/research/pdf-surface-annotation-placement-control.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.