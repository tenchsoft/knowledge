# Implement: alt-f-favorites-toggle-shortcut

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/alt-f-favorites-toggle-shortcut.md`)의 핵심 동작: Alt+F 단축키로 favorites_only 토글 및 논문 목록 즐겨찾기 필터링.
- design(`plans/design/research/alt-f-favorites-toggle-shortcut.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/alt-f-favorites-toggle-shortcut.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.