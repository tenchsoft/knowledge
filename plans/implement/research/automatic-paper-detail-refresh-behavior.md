# Implement: automatic-paper-detail-refresh-behavior

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/automatic-paper-detail-refresh-behavior.md`)의 핵심 동작: selected_paper 변경 시 제목/저자/태그/상태/초록/참고문헌/시각 자동 갱신.
...
8. `plans/test/research/automatic-paper-detail-refresh-behavior.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.