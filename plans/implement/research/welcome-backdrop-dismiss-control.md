# Implement: welcome-backdrop-dismiss-control

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/welcome-backdrop-dismiss-control.md`)의 핵심 동작: 환영 카드 외부 클릭 시 환영 오버레이 닫기.
- design(`plans/design/research/welcome-backdrop-dismiss-control.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.welcome` | `Dialog` | `welcome title` | show_welcome=true |
...
8. `plans/test/research/welcome-backdrop-dismiss-control.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.