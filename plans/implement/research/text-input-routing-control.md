# Implement: text-input-routing-control

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/text-input-routing-control.md`)의 핵심 동작: 일반 텍스트 입력 시 포커스된 검색/Q&A/PDF 검색/DOI/인용 검색 필드에만 라우팅.
- design(`plans/design/research/text-input-routing-control.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/text-input-routing-control.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.