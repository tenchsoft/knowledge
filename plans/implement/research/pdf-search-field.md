# Implement: pdf-search-field

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/pdf-search-field.md`)의 핵심 동작: PDF Search 필드 타이핑 시 pdf_search_query 업데이트.
- design(`plans/design/research/pdf-search-field.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.pdf.search` | `TextInput` | `Search in PDF` | PDF 모드 |
...
8. `plans/test/research/pdf-search-field.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.