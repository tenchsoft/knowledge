# Implement: write-inspector-tab-button

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/write-inspector-tab-button.md`)의 핵심 동작: 인스펙터 Write 탭 버튼 클릭 시 Write 탭 콘텐츠 표시.
- design(`plans/design/research/write-inspector-tab-button.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.inspector.tab.4` | `Tab` | `Write` | right panel width >= 160 |
...
8. `plans/test/research/write-inspector-tab-button.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.