# Implement: apa-citation-format-button

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/apa-citation-format-button.md`)의 핵심 동작: Cite 인스펙터 탭 APA 포맷 버튼 클릭 시 인용 스타일 APA 전환.
- design(`plans/design/research/apa-citation-format-button.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/apa-citation-format-button.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.