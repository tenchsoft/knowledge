# Implement: collection-expand-toggle

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/collection-expand-toggle.md`)의 핵심 동작: 컬렉션 확장 아이콘 클릭 시 컬렉션 행 펼침/접힘 및 선택 상태 유지.
- design(`plans/design/research/collection-expand-toggle.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.collection.{index}.expand` | `Button` | `expand/collapse` | 컬렉션 섹션 |
...
8. `plans/test/research/collection-expand-toggle.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.