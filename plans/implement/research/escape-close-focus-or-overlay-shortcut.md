# Implement: escape-close-focus-or-overlay-shortcut

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/escape-close-focus-or-overlay-shortcut.md`)의 핵심 동작: Escape 시 최우선 오버레이/포커스 닫기, 없으면 검색 초기화 및 Detail 복귀.
- design(`plans/design/research/escape-close-focus-or-overlay-shortcut.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/escape-close-focus-or-overlay-shortcut.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.