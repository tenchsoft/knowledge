# Implement: question-mark-shortcut-help-toggle

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/question-mark-shortcut-help-toggle.md`)의 핵심 동작: ? 키 시 입력 포커스 없으면 단축키 도움말 열림/닫힘 토글.
- design(`plans/design/research/question-mark-shortcut-help-toggle.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/question-mark-shortcut-help-toggle.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.