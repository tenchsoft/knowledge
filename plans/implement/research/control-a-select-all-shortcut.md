# Implement: control-a-select-all-shortcut

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/control-a-select-all-shortcut.md`)의 핵심 동작: Ctrl+A 시 모든 표시 논문 선택 (입력 필드 포커스 시 제외).
- design(`plans/design/research/control-a-select-all-shortcut.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/control-a-select-all-shortcut.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.