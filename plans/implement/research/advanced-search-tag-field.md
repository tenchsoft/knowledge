# Implement: advanced-search-tag-field

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/advanced-search-tag-field.md`)의 핵심 동작: 고급 검색 패널 Tag 필드 타이핑 시 tag_query 업데이트 및 논문 목록 태그 필터링.
- design(`plans/design/research/advanced-search-tag-field.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.advanced.tag` | `TextInput` | `Tag` | show_advanced_search=true |
...
8. `plans/test/research/advanced-search-tag-field.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.