# Implement: pdf-annotation-list-toggle-button

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/pdf-annotation-list-toggle-button.md`)의 핵심 동작: Ann 버튼 클릭 시 pdf_show_annotation_list 전환 및 주석 사이드바 열림/닫힘.
- design(`plans/design/research/pdf-annotation-list-toggle-button.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.pdf.annotation_list_toggle` | `Button` | `annotations` | PDF 모드 |
...
8. `plans/test/research/pdf-annotation-list-toggle-button.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.