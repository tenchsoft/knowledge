# Implement: advanced-search-toggle-button

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/advanced-search-toggle-button.md`)의 핵심 동작: 헤더 검색 영역 고급 검색 토글 클릭 시 패널 열림/닫힘 및 화살표 방향 전환.
- design(`plans/design/research/advanced-search-toggle-button.md`)의 Component breakdown / States를 코드로 옮긴다.
...
|----------|------|-------|----------|
| `research.header.advanced_search` | `Button` | `advanced search` | width >= 700 |
...
8. `plans/test/research/advanced-search-toggle-button.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.