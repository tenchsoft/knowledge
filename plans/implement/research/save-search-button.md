...
## 목표
- spec(`plans/spec/research/save-search-button.md`)의 핵심 동작: Save Search 버튼 클릭 시 현재 검색/고급 조건 저장 및 Search saved 토스트.
- design(`plans/design/research/save-search-button.md`)의 Component breakdown / States를 코드로 옮긴다.
...
8. `plans/test/research/save-search-button.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.