# Implement: automatic-inspector-tab-content-behavior

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec(`plans/spec/research/automatic-inspector-tab-content-behavior.md`)의 핵심 동작: active_inspector_tab 상태에 따라 인스펙터 탭 콘텐츠 자동 전환.
...
8. `plans/test/research/automatic-inspector-tab-content-behavior.md`가 있으면 거기 명시된 테스트 실행하여 통과 확인.