# Implement: shortcut-help-modal-close-button

> 작성 시점과 실행 시점 사이 코드 변경 가능성. 위치는 항상 grep으로 재확인 후 변경.

## 목표
- spec: 단축키 도움말 모달의 Close 버튼 클릭으로 모달을 닫는다
...
- **처리**: close_modals() 호출
- **출력/사이드 이펙트**: show_shortcut_help=false


## 새 자동화 노드
| debug_id | role | value | 노출 조건 |
|----------|------|-------|----------|
| study.modal.close | button | close | show_shortcut_help |
