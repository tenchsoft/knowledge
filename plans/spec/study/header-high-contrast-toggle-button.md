# Spec: header-high-contrast-toggle-button

## 한 줄 정의
사용자가 Study에서 Header High Contrast Toggle Button을/를 클릭하여 수행한다.

## 진입점
- 클릭: 해당 버튼/컨트롤 클릭

## 사용자 흐름
1. 사용자가 Header High Contrast Toggle Button 컨트롤을 확인한다.
